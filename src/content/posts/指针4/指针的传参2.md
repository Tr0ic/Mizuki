---
title: "【C语言】（指针篇）函数传参和void*类型形参"
published: 2025-12-23T10:00:00+08:00
updated: 2025-12-23T10:00:21+08:00
description: "介绍 C 函数指针作为参数的声明与调用，并说明 void* 形参如何接收不同类型的地址。"
tags: ["C"]
category: "C"
author: "Mem0rin"
sourceLink: "https://blog.csdn.net/2501_93882415/article/details/156154264"
draft: false
pinned: false
image: "./cover.jpg"
licenseName: "MIT"
...
- [一、函数传参](#一函数传参)
  - [函数指针](#函数指针)
  - [函数传参的实现](#函数传参的实现)
- [二、void*类型指针作为形参的情况](#二void类型指针作为形参的情况)
