...
category: "Java"
author: "Mem0rin"
sourceLink: "https://blog.csdn.net/2501_93882415/article/details/157137010"
draft: false
pinned: false
image: "./cover.jpg"
licenseName: "MIT"
...
同样你可以在[Java可视化](https://cscircles.cemc.uwaterloo.ca/java_visualize/#code=public+class+StdInDemo+%7B%0A++++public+static+void+main%28String%5B%5D+args%29+%7B%0A+++++++int+bottles+%3D+99%3B%0A+++++++while+%28bottles+%3E+0%29+%7B%0A++++++++++System.out.println%28bottles+%2B+%22+bottles+of+beer+on+the+wall.%22%29%3B%0A++++++++++bottles+%3D+bottles+-+1%3B%0A+++++++%7D%0A++++%7D%0A%7D&mode=display&curInstr=0)中观察其运行的流程。
